...
export class ProductVariantsController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new product variant with optional attributes. SKU must be unique.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    summary: 'List product variants with pagination and filtering',
  })
  ...
  @ApiOperation({
    ...
    description: 'Update variant details. SKU must remain unique.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Sets a variant as the default variant for its product. Unsets previous default.',
  })
  @ApiResponse({
    status: 200,
  ...
  @Permissions(DefaultPermissions.VARIANT_UPDATE)
  @ApiOperation({
    summary: 'Assign attributes to a variant',
    description:
      'Assign attribute-value mappings to a variant. Prevents duplicate attributes.',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid input or duplicate attribute assignment.',
  })
  @ApiResponse({
    status: 404,
    description: 'Variant, attribute, or attribute value not found.',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'Variant or attribute mapping not found.',
  })
