/**
 * Seed script - Product catalog (brands, categories, products, images, variants, inventory)
...
async function seed() {
  ...
  const brands = [
    ...
    { id: U.brand3, name: 'Puma', slug: 'puma', description: 'German sportswear brand' },
    { id: U.brand4, name: 'Under Armour', slug: 'under-armour', description: 'American sportswear brand' },
  ];
  ...
  const cats = [
    ...
    { id: U.cat3, name: 'Casual', slug: 'casual', description: 'Everyday casual wear', sortOrder: 3 },
  ];
  for (const c of cats) {
    await qr.query(
  ...
  const products: ProductSpec[] = [
    // Nike
    { id: pid(1), brandId: U.brand1, categoryId: U.cat1, subCategoryId: U.sub1, name: 'Nike Air Zoom Pegasus 40', slug: 'nike-air-zoom-pegasus-40', skuPrefix: 'NIKE-PEG-40', price: 4399, compareAt: 5499, sizes: ['S', 'M', 'L'] },
    { id: pid(2), brandId: U.brand1, categoryId: U.cat2, subCategoryId: U.sub2, name: 'Nike Dri-FIT Training Tee', slug: 'nike-dri-fit-training-tee', skuPrefix: 'NIKE-DF-TEE', price: 1199, compareAt: 1499, sizes: ['S', 'M', 'L'] },
    { id: pid(3), brandId: U.brand1, categoryId: U.cat1, subCategoryId: U.sub1, name: 'Nike Revolution 6', slug: 'nike-revolution-6', skuPrefix: 'NIKE-REV-6', price: 1999, compareAt: 2499, sizes: ['S', 'M', 'L'] },
    // Adidas
    { id: pid(4), brandId: U.brand2, categoryId: U.cat1, subCategoryId: U.sub1, name: 'Adidas Ultraboost Light', slug: 'adidas-ultraboost-light', skuPrefix: 'ADIDAS-UB-LIGHT', price: 6399, compareAt: 7999, sizes: ['S', 'M', 'L'] },
    { id: pid(5), brandId: U.brand2, categoryId: U.cat2, subCategoryId: U.sub2, name: 'Adidas Essentials Hoodie', slug: 'adidas-essentials-hoodie', skuPrefix: 'ADIDAS-HOODIE', price: 2499, compareAt: 2999, sizes: ['S', 'M', 'L'] },
    { id: pid(6), brandId: U.brand2, categoryId: U.cat2, subCategoryId: U.sub2, name: 'Adidas Training Shorts', slug: 'adidas-training-shorts', skuPrefix: 'ADIDAS-SHORTS', price: 1499, compareAt: 1799, sizes: ['S', 'M', 'L'] },
    { id: pid(7), brandId: U.brand2, categoryId: U.cat3, subCategoryId: U.sub3, name: 'Adidas Originals Forum Low', slug: 'adidas-originals-forum-low', skuPrefix: 'ADIDAS-FORUM', price: 3599, compareAt: 4599, sizes: ['S', 'M', 'L'] },
    // Puma
    { id: pid(8), brandId: U.brand3, categoryId: U.cat2, subCategoryId: U.sub2, name: 'Puma Training Hoodie', slug: 'puma-training-hoodie', skuPrefix: 'PUMA-HOODIE', price: 2199, compareAt: 2799, sizes: ['S', 'M', 'L'] },
    { id: pid(9), brandId: U.brand3, categoryId: U.cat3, subCategoryId: U.sub4, name: 'Puma Classic T-Shirt', slug: 'puma-classic-tshirt', skuPrefix: 'PUMA-TEE', price: 799, compareAt: 999, sizes: ['S', 'M', 'L'] },
    { id: pid(10), brandId: U.brand3, categoryId: U.cat3, subCategoryId: U.sub3, name: 'Puma Carina Street', slug: 'puma-carina-street', skuPrefix: 'PUMA-CARINA', price: 2999, compareAt: 3999, sizes: ['S', 'M', 'L'] },
    // Under Armour
    { id: pid(11), brandId: U.brand4, categoryId: U.cat1, subCategoryId: U.sub1, name: 'UA Charged Assert 10', slug: 'ua-charged-assert-10', skuPrefix: 'UA-ASSERT', price: 2999, compareAt: 3799, sizes: ['S', 'M', 'L'] },
    { id: pid(12), brandId: U.brand4, categoryId: U.cat2, subCategoryId: U.sub2, name: 'UA Tech Short Sleeve', slug: 'ua-tech-short-sleeve', skuPrefix: 'UA-TECH-TEE', price: 999, compareAt: 1299, sizes: ['S', 'M', 'L'] },
  ];
  ...
  console.log('\nProduct catalog seed completed!');
}
